...
export default function Home() {
  ...
  return (
    <main className="flex flex-col max-w-2xl gap-6 p-4">
      <div>
        <div className="bg-gradient-to-br from-[#242424] to-[#1A1A1A] border border-[#333333] rounded-2xl p-6 shadow-lg">
      ...
      <div className="bg-[#242424] border border-[#333333] rounded-2xl overflow-hidden shadow-lg">
