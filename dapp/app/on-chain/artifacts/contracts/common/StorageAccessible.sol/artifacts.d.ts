...
export interface StorageAccessible$Type {
  readonly _format: "hh3-artifact-1";
  readonly contractName: "StorageAccessible";
  readonly sourceName: "contracts/common/StorageAccessible.sol";
...
declare module "hardhat/types/artifacts" {
  interface ArtifactMap {
    ["StorageAccessible"]: StorageAccessible$Type;
    ["contracts/common/StorageAccessible.sol:StorageAccessible"]: StorageAccessible$Type;
  }
}