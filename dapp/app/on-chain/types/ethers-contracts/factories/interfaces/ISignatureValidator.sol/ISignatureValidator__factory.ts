...
/* eslint-disable */
  ...
  import type { ISignatureValidator, ISignatureValidatorInterface } from "../../../interfaces/ISignatureValidator.sol/ISignatureValidator.js";
  ...
  export class ISignatureValidator__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): ISignatureValidator {
      return new Contract(address, _abi, runner) as unknown as ISignatureValidator;
    }
  }
