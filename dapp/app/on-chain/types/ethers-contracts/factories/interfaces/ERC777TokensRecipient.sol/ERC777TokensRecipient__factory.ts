...
/* eslint-disable */
  ...
  import type { ERC777TokensRecipient, ERC777TokensRecipientInterface } from "../../../interfaces/ERC777TokensRecipient.sol/ERC777TokensRecipient.js";
  ...
  export class ERC777TokensRecipient__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): ERC777TokensRecipient {
      return new Contract(address, _abi, runner) as unknown as ERC777TokensRecipient;
    }
  }
