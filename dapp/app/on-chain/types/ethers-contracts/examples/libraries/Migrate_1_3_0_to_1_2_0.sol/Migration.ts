...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface MigrationInterface extends Interface {
    getFunction(nameOrSignature: "MIGRATION_SINGLETON" | "SAFE_120_SINGLETON" | "migrate"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'SAFE_120_SINGLETON', values?: undefined): string;
encodeFunctionData(functionFragment: 'migrate', values?: undefined): string;

    decodeFunctionResult(functionFragment: 'MIGRATION_SINGLETON', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'SAFE_120_SINGLETON', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'migrate', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    SAFE_120_SINGLETON: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'MIGRATION_SINGLETON'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'SAFE_120_SINGLETON'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
