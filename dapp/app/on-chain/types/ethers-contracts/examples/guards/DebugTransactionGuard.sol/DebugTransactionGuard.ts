...
decodeFunctionResult(functionFragment: 'txNonces', data: BytesLike): Result;
    ...
    export namespace GasUsageEvent {
      export type InputTuple = [safe: AddressLike, txHash: BytesLike, nonce: BigNumberish, success: boolean];
      export type OutputTuple = [safe: string, txHash: string, nonce: bigint, success: boolean];
      export interface OutputObject {safe: string, txHash: string, nonce: bigint, success: boolean };
    ...
    export namespace ModuleTransactionDetailsEvent {
      export type InputTuple = [txHash: BytesLike, to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, module: AddressLike];
      export type OutputTuple = [txHash: string, to: string, value: bigint, data: string, operation: bigint, module: string];
      export interface OutputObject {txHash: string, to: string, value: bigint, data: string, operation: bigint, module: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace TransactionDetailsEvent {
      export type InputTuple = [safe: AddressLike, txHash: BytesLike, to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, usesRefund: boolean, nonce: BigNumberish, signatures: BytesLike, executor: AddressLike];
      export type OutputTuple = [safe: string, txHash: string, to: string, value: bigint, data: string, operation: bigint, safeTxGas: bigint, usesRefund: boolean, nonce: bigint, signatures: string, executor: string];
      export interface OutputObject {safe: string, txHash: string, to: string, value: bigint, data: string, operation: bigint, safeTxGas: bigint, usesRefund: boolean, nonce: bigint, signatures: string, executor: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    checkModuleTransaction: TypedContractMethod<
      [to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, module: AddressLike, ],
      [string],
      'nonpayable'
    >
    ...
    checkTransaction: TypedContractMethod<
      [to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, baseGas: BigNumberish, gasPrice: BigNumberish, gasToken: AddressLike, refundReceiver: AddressLike, signatures: BytesLike, executor: AddressLike, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'supportsInterface'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'txNonces'): TypedContractMethod<
      [arg0: BytesLike, ],
      [bigint],
      'view'
    >;
