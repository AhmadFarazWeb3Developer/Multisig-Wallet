...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface DelegateCallTransactionGuardInterface extends Interface {
    getFunction(nameOrSignature: "ALLOWED_TARGET" | "checkAfterExecution" | "checkAfterModuleExecution" | "checkModuleTransaction" | "checkTransaction" | "supportsInterface"): FunctionFragment;

    

    encodeFunctionData(functionFragment: 'ALLOWED_TARGET', values?: undefined): string;
...
encodeFunctionData(functionFragment: 'supportsInterface', values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: 'ALLOWED_TARGET', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'supportsInterface', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    ALLOWED_TARGET: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    checkTransaction: TypedContractMethod<
      [to: AddressLike, arg1: BigNumberish, arg2: BytesLike, operation: BigNumberish, arg4: BigNumberish, arg5: BigNumberish, arg6: BigNumberish, arg7: AddressLike, arg8: AddressLike, arg9: BytesLike, arg10: AddressLike, ],
      [void],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'ALLOWED_TARGET'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
