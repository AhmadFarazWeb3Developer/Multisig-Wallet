...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface SafeProxyInterface extends Interface {
  ...
  export interface SafeProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): SafeProxy;
    waitForDeployment(): Promise<this>;

    interface: SafeProxyInterface;
