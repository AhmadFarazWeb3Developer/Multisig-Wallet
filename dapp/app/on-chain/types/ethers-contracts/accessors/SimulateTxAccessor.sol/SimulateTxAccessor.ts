...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface SimulateTxAccessorInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: 'simulate', values: [AddressLike, BigNumberish, BytesLike, BigNumberish]): string;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    simulate: TypedContractMethod<
      ...
      [[bigint, boolean, string] & {estimate: bigint, success: boolean, returnData: string }],
      'nonpayable'
    >
