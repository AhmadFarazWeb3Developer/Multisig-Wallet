...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IFallbackManagerInterface extends Interface {
  ...
  export interface IFallbackManager extends BaseContract {
    
    connect(runner?: ContractRunner | null): IFallbackManager;
    waitForDeployment(): Promise<this>;

    interface: IFallbackManagerInterface;
