...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IStorageAccessibleInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'simulateAndRevert', data: BytesLike): Result;
  ...
  export interface IStorageAccessible extends BaseContract {
    
    connect(runner?: ContractRunner | null): IStorageAccessible;
    waitForDeployment(): Promise<this>;

    interface: IStorageAccessibleInterface;
