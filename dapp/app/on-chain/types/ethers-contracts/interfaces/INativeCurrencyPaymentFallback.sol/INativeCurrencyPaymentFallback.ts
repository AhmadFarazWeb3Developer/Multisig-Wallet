...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../common.js"
  ...
  export interface INativeCurrencyPaymentFallbackInterface extends Interface {
  ...
  export interface INativeCurrencyPaymentFallback extends BaseContract {
    
    connect(runner?: ContractRunner | null): INativeCurrencyPaymentFallback;
    waitForDeployment(): Promise<this>;

    interface: INativeCurrencyPaymentFallbackInterface;
