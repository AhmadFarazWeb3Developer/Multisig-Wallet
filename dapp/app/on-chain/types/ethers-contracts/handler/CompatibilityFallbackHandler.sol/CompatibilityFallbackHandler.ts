...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface CompatibilityFallbackHandlerInterface extends Interface {
    getFunction(nameOrSignature: "encodeMessageDataForSafe" | "encodeTransactionData" | "getMessageHash" | "getMessageHashForSafe" | "getModules" | "isValidSignature" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "simulate" | "supportsInterface" | "tokensReceived"): FunctionFragment;

    

    encodeFunctionData(functionFragment: 'encodeMessageDataForSafe', values: [AddressLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'encodeTransactionData', values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BigNumberish, BigNumberish, BigNumberish, AddressLike, AddressLike, BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'tokensReceived', values: [AddressLike, AddressLike, AddressLike, BigNumberish, BytesLike, BytesLike]): string;
...
decodeFunctionResult(functionFragment: 'tokensReceived', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    encodeTransactionData: TypedContractMethod<
      [to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, baseGas: BigNumberish, gasPrice: BigNumberish, gasToken: AddressLike, refundReceiver: AddressLike, nonce: BigNumberish, ],
      [string],
      'view'
    >
