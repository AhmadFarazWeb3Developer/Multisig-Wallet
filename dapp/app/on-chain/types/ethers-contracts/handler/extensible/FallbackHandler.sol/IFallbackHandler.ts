...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface IFallbackHandlerInterface extends Interface {
    getFunction(nameOrSignature: "setSafeMethod"): FunctionFragment;
  ...
  export interface IFallbackHandler extends BaseContract {
    
    connect(runner?: ContractRunner | null): IFallbackHandler;
    waitForDeployment(): Promise<this>;

    interface: IFallbackHandlerInterface;
