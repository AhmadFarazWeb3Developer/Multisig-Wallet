...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface SafeL2Interface extends Interface {
    getFunction(nameOrSignature: "VERSION" | "addOwnerWithThreshold" | "approveHash" | "approvedHashes" | "changeThreshold" | "checkNSignatures(bytes32,bytes,bytes,uint256)" | "checkNSignatures(address,bytes32,bytes,uint256)" | "checkSignatures(bytes32,bytes,bytes)" | "checkSignatures(address,bytes32,bytes)" | "disableModule" | "domainSeparator" | "enableModule" | "execTransaction" | "execTransactionFromModule" | "execTransactionFromModuleReturnData" | "getModulesPaginated" | "getOwners" | "getStorageAt" | "getThreshold" | "getTransactionHash" | "isModuleEnabled" | "isOwner" | "nonce" | "removeOwner" | "setFallbackHandler" | "setGuard" | "setModuleGuard" | "setup" | "signedMessages" | "simulateAndRevert" | "swapOwner"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "AddedOwner" | "ApproveHash" | "ChangedFallbackHandler" | "ChangedGuard" | "ChangedModuleGuard" | "ChangedThreshold" | "DisabledModule" | "EnabledModule" | "ExecutionFailure" | "ExecutionFromModuleFailure" | "ExecutionFromModuleSuccess" | "ExecutionSuccess" | "RemovedOwner" | "SafeModuleTransaction" | "SafeMultiSigTransaction" | "SafeReceived" | "SafeSetup" | "SignMsg"): EventFragment;
...
encodeFunctionData(functionFragment: 'checkNSignatures(bytes32,bytes,bytes,uint256)', values: [BytesLike, BytesLike, BytesLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'checkNSignatures(address,bytes32,bytes,uint256)', values: [AddressLike, BytesLike, BytesLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'checkSignatures(bytes32,bytes,bytes)', values: [BytesLike, BytesLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'checkSignatures(address,bytes32,bytes)', values: [AddressLike, BytesLike, BytesLike]): string;
...
encodeFunctionData(functionFragment: 'execTransaction', values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BigNumberish, BigNumberish, BigNumberish, AddressLike, AddressLike, BytesLike]): string;
...
encodeFunctionData(functionFragment: 'getTransactionHash', values: [AddressLike, BigNumberish, BytesLike, BigNumberish, BigNumberish, BigNumberish, BigNumberish, AddressLike, AddressLike, BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'setup', values: [AddressLike[], BigNumberish, AddressLike, BytesLike, AddressLike, AddressLike, BigNumberish, AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'swapOwner', data: BytesLike): Result;
    ...
    export namespace ApproveHashEvent {
      ...
      export interface OutputObject {approvedHash: string, owner: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ChangedFallbackHandlerEvent {
      ...
      export interface OutputObject {handler: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ChangedModuleGuardEvent {
      ...
      export interface OutputObject {moduleGuard: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace ExecutionFailureEvent {
      ...
      export interface OutputObject {txHash: string, payment: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace SafeModuleTransactionEvent {
      export type InputTuple = [module: AddressLike, to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish];
      export type OutputTuple = [module: string, to: string, value: bigint, data: string, operation: bigint];
      export interface OutputObject {module: string, to: string, value: bigint, data: string, operation: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace SafeMultiSigTransactionEvent {
      export type InputTuple = [to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, baseGas: BigNumberish, gasPrice: BigNumberish, gasToken: AddressLike, refundReceiver: AddressLike, signatures: BytesLike, additionalInfo: BytesLike];
      export type OutputTuple = [to: string, value: bigint, data: string, operation: bigint, safeTxGas: bigint, baseGas: bigint, gasPrice: bigint, gasToken: string, refundReceiver: string, signatures: string, additionalInfo: string];
      export interface OutputObject {to: string, value: bigint, data: string, operation: bigint, safeTxGas: bigint, baseGas: bigint, gasPrice: bigint, gasToken: string, refundReceiver: string, signatures: string, additionalInfo: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace SafeSetupEvent {
      export type InputTuple = [initiator: AddressLike, owners: AddressLike[], threshold: BigNumberish, initializer: AddressLike, fallbackHandler: AddressLike];
      export type OutputTuple = [initiator: string, owners: string[], threshold: bigint, initializer: string, fallbackHandler: string];
      export interface OutputObject {initiator: string, owners: string[], threshold: bigint, initializer: string, fallbackHandler: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface SafeL2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): SafeL2;
    waitForDeployment(): Promise<this>;

    interface: SafeL2Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    execTransaction: TypedContractMethod<
      [to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, baseGas: BigNumberish, gasPrice: BigNumberish, gasToken: AddressLike, refundReceiver: AddressLike, signatures: BytesLike, ],
      [boolean],
      'payable'
    >
    ...
    getTransactionHash: TypedContractMethod<
      [to: AddressLike, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, baseGas: BigNumberish, gasPrice: BigNumberish, gasToken: AddressLike, refundReceiver: AddressLike, _nonce: BigNumberish, ],
      [string],
      'view'
    >
    ...
    setup: TypedContractMethod<
      [_owners: AddressLike[], _threshold: BigNumberish, to: AddressLike, data: BytesLike, fallbackHandler: AddressLike, paymentToken: AddressLike, payment: BigNumberish, paymentReceiver: AddressLike, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'changeThreshold'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'checkNSignatures(bytes32,bytes,bytes,uint256)'): TypedContractMethod<
      [dataHash: BytesLike, data: BytesLike, signatures: BytesLike, requiredSignatures: BigNumberish, ],
      [void],
      'view'
    >;
getFunction(nameOrSignature: 'checkNSignatures(address,bytes32,bytes,uint256)'): TypedContractMethod<
      [executor: AddressLike, dataHash: BytesLike, signatures: BytesLike, requiredSignatures: BigNumberish, ],
      [void],
      'view'
    >;
getFunction(nameOrSignature: 'checkSignatures(bytes32,bytes,bytes)'): TypedContractMethod<
      [dataHash: BytesLike, data: BytesLike, signatures: BytesLike, ],
      [void],
      'view'
    >;
getFunction(nameOrSignature: 'checkSignatures(address,bytes32,bytes)'): TypedContractMethod<
      [executor: AddressLike, dataHash: BytesLike, signatures: BytesLike, ],
      [void],
      'view'
    >;
...
getFunction(nameOrSignature: 'getTransactionHash'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'isModuleEnabled'): TypedContractMethod<
      [module: AddressLike, ],
      [boolean],
      'view'
    >;
...
getFunction(nameOrSignature: 'removeOwner'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setFallbackHandler'): TypedContractMethod<
      [handler: AddressLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setGuard'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setModuleGuard'): TypedContractMethod<
      [moduleGuard: AddressLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setup'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'signedMessages'): TypedContractMethod<
      [arg0: BytesLike, ],
      [bigint],
      'view'
    >;
...
getEvent(key: 'ChangedModuleGuard'): TypedContractEvent<ChangedModuleGuardEvent.InputTuple, ChangedModuleGuardEvent.OutputTuple, ChangedModuleGuardEvent.OutputObject>;
...
getEvent(key: 'SafeModuleTransaction'): TypedContractEvent<SafeModuleTransactionEvent.InputTuple, SafeModuleTransactionEvent.OutputTuple, SafeModuleTransactionEvent.OutputObject>;
getEvent(key: 'SafeMultiSigTransaction'): TypedContractEvent<SafeMultiSigTransactionEvent.InputTuple, SafeMultiSigTransactionEvent.OutputTuple, SafeMultiSigTransactionEvent.OutputObject>;
...
getEvent(key: 'SignMsg'): TypedContractEvent<SignMsgEvent.InputTuple, SignMsgEvent.OutputTuple, SignMsgEvent.OutputObject>;
    ...
    filters: {
      ...
      'ChangedModuleGuard(address)': TypedContractEvent<ChangedModuleGuardEvent.InputTuple, ChangedModuleGuardEvent.OutputTuple, ChangedModuleGuardEvent.OutputObject>;
      ChangedModuleGuard: TypedContractEvent<ChangedModuleGuardEvent.InputTuple, ChangedModuleGuardEvent.OutputTuple, ChangedModuleGuardEvent.OutputObject>;
      ...
      'SafeModuleTransaction(address,address,uint256,bytes,uint8)': TypedContractEvent<SafeModuleTransactionEvent.InputTuple, SafeModuleTransactionEvent.OutputTuple, SafeModuleTransactionEvent.OutputObject>;
      SafeModuleTransaction: TypedContractEvent<SafeModuleTransactionEvent.InputTuple, SafeModuleTransactionEvent.OutputTuple, SafeModuleTransactionEvent.OutputObject>;
    

      'SafeMultiSigTransaction(address,uint256,bytes,uint8,uint256,uint256,uint256,address,address,bytes,bytes)': TypedContractEvent<SafeMultiSigTransactionEvent.InputTuple, SafeMultiSigTransactionEvent.OutputTuple, SafeMultiSigTransactionEvent.OutputObject>;
      SafeMultiSigTransaction: TypedContractEvent<SafeMultiSigTransactionEvent.InputTuple, SafeMultiSigTransactionEvent.OutputTuple, SafeMultiSigTransactionEvent.OutputObject>;
