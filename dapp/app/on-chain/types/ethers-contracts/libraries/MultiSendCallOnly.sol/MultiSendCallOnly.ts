...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface MultiSendCallOnlyInterface extends Interface {
  ...
  export interface MultiSendCallOnly extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): MultiSendCallOnly;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getFunction(nameOrSignature: 'multiSend'): TypedContractMethod<
      [transactions: BytesLike, ],
      [void],
      'payable'
    >;
