...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IModuleGuardInterface extends Interface {
    getFunction(nameOrSignature: "checkAfterModuleExecution" | "checkModuleTransaction" | "supportsInterface"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'supportsInterface', data: BytesLike): Result;
  ...
  export interface IModuleGuard extends BaseContract {
    
    connect(runner?: ContractRunner | null): IModuleGuard;
    waitForDeployment(): Promise<this>;

    interface: IModuleGuardInterface;
